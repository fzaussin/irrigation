...
irrig_I = slopes.new_slope_metric(slopes_I).resample('M').sum()

slopes_NI = slopes.diffquot_slope(ts_NI)
irrig_NI = slopes.new_slope_metric(slopes_NI).resample('M').sum()
...
ax4 = plt.subplot2grid((2, 2), (1, 1), sharex=ax1, sharey=ax3)
...
# SMAP
irrig_I['SMAP'].plot.area(ax=ax3, label='I', ylim=(0, y_max_irrig), color='#fdb462', stacked=False)
irrig_NI['SMAP'].plot.area(ax=ax4, label='NI', ylim=(0, y_max_irrig), color='#fdb462', stacked=False)
# AMSR2
irrig_I['AMSR2'].plot.area(ax=ax3, label='I', ylim=(0, y_max_irrig), color='#80b1d3', stacked=False)
irrig_NI['AMSR2'].plot.area(ax=ax4, label='NI', ylim=(0, y_max_irrig), color='#80b1d3', stacked=False)
# ASCAT
irrig_I['ASCAT'].plot.area(ax=ax3, label='I', ylim=(0, y_max_irrig), color='#fb8072', stacked=False)
irrig_NI['ASCAT'].plot.area(ax=ax4, label='NI', ylim=(0, y_max_irrig), color='#fb8072', stacked=False)
