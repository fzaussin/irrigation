...
def spatial_plot_quarter_grid(data, tags=None, region='USA', title='', tag_title=False,
                              cblabel='', cbrange=None, cmap='YlGn', labelpad=-75,
...
if __name__ == '__main__':
    import pandas as pd
    data = pd.DataFrame.from_csv('/home/fzaussin/shares/users/Earth2Observe/Mirad-US_Downscaling/1000m_lon_lat_data_list.csv')
    data = data[1000:12000]
    spatial_plot(data)