...
if __name__ == '__main__':
    #from _projects.Irrigation_Analysis.irrigation-OLD.vis import spatial_plot
    #from _projects.Irrigation_Analysis.irrigation-OLD.trans import path_manipulation as pm
    ...
    Plot LC-MASK
    """
    data_temp = lcmask_tresh(0.7)
    out = '/home/fzaussin/shares/users/Earth2Observe/Irrigation/Plots'
    # temp lcmask plot in ylgn
    print data_temp
    """
